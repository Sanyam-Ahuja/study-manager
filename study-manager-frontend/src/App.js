...
function App() {
  ...
  const fetchSubjects = (authToken) => {
    axios.get('https://study-manager-production.up.railway.app:8080/api/subjects', {
  ...
  const fetchChapterDuration = (chapterId, authToken) => {
    return axios.get(`https://study-manager-production.up.railway.app:8080/api/chapters/${chapterId}/duration`, {
      headers: { 'Authorization': authToken }
    })
      .then(response => {
  ...
  const fetchChapters = (subjectId, authToken) => {
    axios.get(`https://study-manager-production.up.railway.app:8080/api/subjects/${subjectId}/chapters`, {
      headers: { 'Authorization': authToken }
    })
      .then(response => {
  ...
  const fetchLectures = (chapterId, authToken) => {
    axios.get(`https://study-manager-production.up.railway.app:8080/api/chapters/${chapterId}/lectures`, {
      headers: { 'Authorization': authToken }
    })
      .then(response => {
  ...
  const fetchSubjectDuration = (subjectId, authToken) => {
    axios.get(`https://study-manager-production.up.railway.app:8080/api/subjects/${subjectId}/duration`, {
      headers: { 'Authorization': authToken }
    })
      .then(response => {
        const { watched_duration, total_duration } = response.data;
  ...
  const toggleWatchedStatus = (lectureId, authToken) => {
    return axios.put(`https://study-manager-production.up.railway.app:8080/api/lectures/${lectureId}/toggle-watched`, {}, {
      headers: { 'Authorization': authToken }
    })
      .then(response => {
  ...
  const handleRegister = () => {
    axios.post('https://study-manager-production.up.railway.app:8080/api/register', { username, password })
      .then(response => {
  ...
  const handleLogin = () => {
    axios.post('https://study-manager-production.up.railway.app:8080/api/login', { username, password })
      .then(response => {
